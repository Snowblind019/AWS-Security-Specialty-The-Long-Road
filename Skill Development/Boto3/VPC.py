...
if vpcs:
    ...
    # Tags can't be assigned immediately after VPC creation
    time.sleep(5)
...
# Create a route table with a public route to the internet gateway
...
# Create 3 subnets across different availability zones
